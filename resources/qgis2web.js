...
map.getView().fit([8479793.001225, 1106452.169881, 8504613.426142, 1125381.646658], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h1 class="project-title">Haritha Karma Sena Dashboard</h1>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (28 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = '<h4>theme description</h4>   <br><h5>Click on a ward to see information for it. <br />Click the top-right button to hide/reveal wards or points. <br />Navigate to the rest of themes with the links in the bottom left.</h5>';
            }
